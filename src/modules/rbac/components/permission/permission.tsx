...
import CheckboxList from '@/modules/rbac/components/checkbox/checkbox';
...
import FeaturePermissionService from '@/modules/rbac/services/featurePermission.service';
