...
import UserRoleService from '@/modules/rbac/services/userRole.service';
...
const DetailedUserData = React.lazy(() => import('@/modules/rbac/components/detailedUser/detailedUser'))
